...
/**
 * Title: Search
 * Slug: cakified/search
 * Categories: cakified, search
 */
?>
...
<div class="wp-block-group alignwide"><!-- wp:query-title {"type":"search","textAlign":"center","style":{"typography":{"textTransform":"uppercase","letterSpacing":"1px","fontSize":"42px","fontStyle":"normal","fontWeight":"700"}},"textColor":"white"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
